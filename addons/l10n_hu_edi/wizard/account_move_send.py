...
class AccountMoveSend(models.TransientModel):
    ...
    def _compute_l10n_hu_edi_enable_nav_30(self):
        for wizard in self:
            enabled_moves = wizard.move_ids.filtered(
                lambda m: m._l10n_hu_edi_get_valid_action() in ['start', 'upload', 'query_status', 'recover_timeout']
            )._origin
    ...
    def _need_invoice_document(self, invoice):
        ...
        return super()._need_invoice_document(invoice) or invoice._l10n_hu_edi_get_valid_action() == 'start'
    ...
    def _hook_invoice_document_before_pdf_report_render(self, invoice, invoice_data):
        ...
        if (
            ...
            and invoice._l10n_hu_edi_get_valid_action() == 'start'
    ...
    def _call_web_service_before_invoice_pdf_render(self, invoices_data):
        ...
        invoices_hu = self.env['account.move'].browse([
            ...
            if invoice_data.get('l10n_hu_edi_checkbox_nav_30')
               and invoice._l10n_hu_edi_get_valid_action() in ['start', 'upload', 'query_status', 'recover_timeout']
        ])
        ...
        with invoices_hu._l10n_hu_edi_acquire_lock():
            ...
            invoices_hu.filtered(lambda m: m._l10n_hu_edi_get_valid_action() == 'start')._l10n_hu_edi_start()
    ...
    def _l10n_hu_edi_perform_action(self, invoices_data, action):
        ...
        invoices = self.env['account.move'].browse([invoice.id for invoice in invoices_data]).filtered(lambda m: m._l10n_hu_edi_get_valid_action() == action)
